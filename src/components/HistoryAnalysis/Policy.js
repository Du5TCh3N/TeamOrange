...
const Policy = () => {
    ...
    return (
        ...
        <Row gutter={[16,16]}>
            ...
            <Col span={24}>
                <Card title="Royal Borough of Kingston upon Thames Housing Allocation Scheme 2017 " bordered={false}>
            ...
            <br></br>
            <Col span={24}>
                <Card title="How the Housing Allocations Scheme was developed" bordered={false}>
            ...
            <Col span={24}>
                <Card title="Aims and Objectives" bordered={false}>
            ...
            <Col span={24}>
                <Card title="Legal Framework" bordered={false}>
            ...
            <Col span={24}>
                <Card title="Equality" bordered={false}>
