...
export default function SimulationDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SimulationData(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SimulationDataCreateForm")}
      {...rest}
    >
      <ArrayField
